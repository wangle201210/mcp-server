module github.com/wangle201210/mcp-server
...
require (
	...
	github.com/wangle201210/text2sql v0.0.3
)
...
require (
	...
	github.com/cloudwego/eino-ext/components/model/openai v0.0.0-20250225083118-fd27d80f189c // indirect
